...
GroundShader::GroundShader(vrlib::tien::Terrain &terrain) : terrain(terrain)
{
...
void GroundShader::update(float elapsedTime, vrlib::tien::Scene& scene)
{
	time += elapsedTime;
}


void GroundShader::drawDeferredPass()
{
...
void GroundShader::drawShadowMap()
{
}

json GroundShader::toJson(json &meshes) const
{
	json ret;
	ret["type"] = "grass";
	return ret;
...
void GroundShader::GrassRenderContext::frameSetup(const glm::mat4 &projectionMatrix, const glm::mat4 &viewMatrix)
{
	renderShader->use();
...
void GroundShader::GrassRenderContext::init()
{
